define([], function() {
    ...
    var en = {
		translation : {
			...
			node19 : {
				name: 'Yanagi Shinzou',
				text: 'I am originally from Takamatsu; however, I feel attached to Megijima as if it were my birth home. From the fertile soil and thriving vegetation, to the warm and hospitable inhabitants, I love everything about Megijima.<br>Of my many fond memories of the island, is my first trip to Oni’s cave. I was just a child, but I can still remember the feeling of the cool temperature on my skin. There is a certain power in Megijima, which is why I am so passionate about working here and helping Megijima to be the best it can be.',
				crops: []
			},
			node20 : {
			...
			node21 : {
				...
				text: 'I have four siblings and we are all very close. I have more chances to spend time with them than with my friends. When we have any problem I always talk with them and they help me any way that they can. This is the importance of family.<br>I recommend goya as the favorite food from this island. A few years ago, I started to grow goya for personal consumption. At this time, others on the island began growing it as well. Since my health is not what it once was, I am careful to not work too much, but I enjoy the time I spend in the garden and it does not feel like work. ',
				crops: ['cucumber', 'eggplant', 'green pepper', 'goya']
			},
			node22 : {
				name: 'Okamoto Ayako',
			...
			node23 : {
				name: 'Shibamoto Eiko',
				text: 'We have been enjoying the farmer life for many years. We have one small farm in the front of our home and another up in the hill. It is a peaceful place with a wonderful view of the ocean, Yashima, Takamatsu, and other nearby places. Usually we are able to farm from year to year without any problems; however, there was one year we had to close one of our farms due to wild boars (inoshishi).',
				crops: ['peanut']
			},
			node24 : {
			...
			node29 : {
				...
				text: 'Megijima is said to be the "Island of the cherry tree." In the spring time, with the perfume of the blossoming cherry blossoms wafting through the breeze and the vibrant pink petals carpeting the narrow roads, Megijima is a very beautiful place indeed.<br>The view of Takamatsu from Megijima creates a dynamic contrast between a modern Japanese city and the serenity of a traditional country scape. This juxtaposition amplifies the beauty and power of both environments, adding to Megijima’s splendor.',
				crops: ['basil', 'corn', 'grape', 'tomato']
			},
			node30 : {
				name: 'Kawai Miho',
				text: 'When I was 18 years-old, I left Megijima for Nagano and Osaka. I lived in Osaka around 10 years and came back to Megijima 17 or 18 years ago.<br>A very special thing about Megijima is the night view of Takamatsu. In addition, the Great Seto Bridge, the sunsets, and the stars at night are very beautiful. Because of the lack of city lights, Megijima gets very dark, making the stars shimmer against a pitch black backdrop.',
				crops: ['peanut', 'sweet potato', 'corn', 'wheat']
			},
			node31 : {
